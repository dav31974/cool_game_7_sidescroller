window.addEventListener('load', function () {
    ...
    class InputHandler {
        constructor() {
            this.keys = [];
            this.touchY = '';
            this.touchTreshold = 50; // seuil de tolerence (mobile touch)
    ...
    class Player {
        ...
        update(input, deltaTime, enemies) {
            ...
            // vertical movement
            this.y += this.vy;
            if (!this.onGround()) { // si le player est dans l'air 
                this.vy += this.weight;  // le player redescend en fonction de son poids
                this.maxFrameX = 5;
                this.frameY = 1;
            } else {
                this.vy = 0;  // si le player est au sol, vy = 0
                this.maxFrameX = 8;
                this.frameY = 0;
            }
    ...
    function displayStatusText(context) {
        ...
        if (gameOver) {
            ...
            context.fillStyle = 'white';
            context.fillText('GAME OVER, press Enter or swipe down to restart!', canvas.width / 2 + 3, 200 + 3);
        }
    }
